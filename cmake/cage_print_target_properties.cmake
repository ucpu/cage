...
function(cage_print_target_property target property)
...
function(cage_print_target_properties target)
	message(STATUS "----------------------------------------------------------------")
	...
	foreach(prop ${properties})
		...
		if(hasconfig EQUAL -1)
			cage_print_target_property(${target} ${prop})
		else()
			foreach(conf ${configs})
				string(REPLACE "<CONFIG>" ${conf} propc ${prop})
				cage_print_target_property(${target} ${propc})
			endforeach()
		endif()
	endforeach(prop)

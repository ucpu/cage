...
function(cage_output_data where)
	...
	cage_directory_link("${cage_output_data_source}/../data/cage" "${where}/data/cage")
	configure_file("${cage_output_data_source}/../include/cage-client/graphic/shaderConventions.h" "${where}/data" COPYONLY)

...
macro(cage_gen_module name lib inc)
	...
	set(filenames "${CAGE_EXTERNALS_MODULE_PATH}/Find${name_upper}.cmake")
	if(NOT WIN32 AND NOT "${name_upper}" STREQUAL "${name}")
		list(APPEND filenames "${CAGE_EXTERNALS_MODULE_PATH}/Find${name}.cmake")
	endif()

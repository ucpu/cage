...
void testClasses()
{
...

	{
		...
		CAGE_TEST((systemMemory().createHolder<Base>().dynCast<Base>()));
		CAGE_TEST((systemMemory().createImpl<Base, Derived>().dynCast<Base>()));
		CAGE_TEST((systemMemory().createImpl<Base, Derived>().dynCast<Derived>()));
		CAGE_TEST_THROWN((systemMemory().createImpl<Base, Derived>().dynCast<OtherDerived>()));

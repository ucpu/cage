...
void testArchivesZip()
{
...

	{
		...
		pathCreateArchiveZip(directories[1]);
...

	{
		...
		CAGE_TEST_THROWN(pathCreateArchiveZip(directories[1])); // already existing archive
		pathCreateDirectories("testdir/archiveplaceholder");
		CAGE_TEST_THROWN(pathCreateArchiveZip("testdir/archiveplaceholder")); // already existing folder
	}
...

	{
		...
		}
		{
			...
			testListRecursive();
			pathCreateArchiveZip("testdir/arch3.zip");
		...
		}
		{
			...
			pathCreateArchiveZip("testdir/movingarch.zip");
...

	{
		...
		pathCreateArchiveZip("testdir/arch2.zip");
		{
...

	{
		...
		pathCreateArchiveZip("testdir/keep-open/archive.zip");
...

	{
		...
		pathCreateArchiveZip("testdir/arch5.zip");
		{

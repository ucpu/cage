...
#define CAGE_TESTCASE(NAME) CAGE_LOG(SeverityEnum::Info, "testcase", stringizer() + string().fill(CageTestCase::counter * 4, ' ') + NAME); CageTestCase CAGE_JOIN(cageTestCase_, __LINE__);

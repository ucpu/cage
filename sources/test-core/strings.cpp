...
namespace
{
	...
	void testConstructors()
	{
		...
		char c = 'k';
		CAGE_TEST(String(Stringizer() + c) == "107");
		int i1 = -123;
		CAGE_TEST(String(Stringizer() + i1) == "-123");
		unsigned int i2 = 124;
		CAGE_TEST(String(Stringizer() + i2) == "124");
		sint8 i3 = 125;
		CAGE_TEST(String(Stringizer() + i3) == "125");
		sint16 i4 = 126;
		CAGE_TEST(String(Stringizer() + i4) == "126");
		sint32 i5 = 127;
		CAGE_TEST(String(Stringizer() + i5) == "127");
		sint64 i6 = 128;
		CAGE_TEST(String(Stringizer() + i6) == "128");
		uint8 i7 = 113;
		CAGE_TEST(String(Stringizer() + i7) == "113");
		uint16 i8 = 114;
		CAGE_TEST(String(Stringizer() + i8) == "114");
		uint32 i9 = 115;
		CAGE_TEST(String(Stringizer() + i9) == "115");
		uint64 i10 = 116;
		CAGE_TEST(String(Stringizer() + i10) == "116");
		{
			float f = 5;

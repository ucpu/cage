...
#define CAGE_SHADER_ROUTINEUNIF_AMBIENT 1
#define CAGE_SHADER_ROUTINEUNIF_MAPALBEDO 2
#define CAGE_SHADER_ROUTINEUNIF_MAPSPECIAL 3
#define CAGE_SHADER_ROUTINEUNIF_MAPNORMAL 4

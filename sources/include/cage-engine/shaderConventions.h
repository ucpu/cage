...
#define CAGE_SHADER_TEXTURE_COLOR 0
#define CAGE_SHADER_TEXTURE_DEPTH 1
#define CAGE_SHADER_TEXTURE_EFFECTS 2
...
#define CAGE_SHADER_UNIBLOCK_EFFECT_PROPERTIES 1
#define CAGE_SHADER_UNIBLOCK_SSAO_POINTS 2

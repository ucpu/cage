...
#undef GCHL_GENERATE
	...
	CAGE_FORCE_INLINE constexpr bool operator == (const Vec2i &l, const Vec2i &r) noexcept { return l.data[0] == r.data[0] && l.data[1] == r.data[1]; }
	CAGE_FORCE_INLINE constexpr bool operator == (const Vec3i &l, const Vec3i &r) noexcept { return l.data[0] == r.data[0] && l.data[1] == r.data[1] && l.data[2] == r.data[2]; }
	CAGE_FORCE_INLINE constexpr bool operator == (const Vec4i &l, const Vec4i &r) noexcept { return l.data[0] == r.data[0] && l.data[1] == r.data[1] && l.data[2] == r.data[2] && l.data[3] == r.data[3]; }

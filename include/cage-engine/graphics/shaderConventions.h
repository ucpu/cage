...
#define CAGE_SHADER_ATTRIB_OUT_VELOCITY 3
#define CAGE_SHADER_ATTRIB_OUT_COLOR 4
...
#define CAGE_SHADER_UNI_AMBIENTOCCLUSION 2
#define CAGE_SHADER_UNI_ROUTINES 3
...
#define CAGE_SHADER_ROUTINEPROC_LIGHTFORWARDBASE 19
